export default function SessionsLoading() {
    return (
        <div className="p-4 sm:p-8 max-w-7xl mx-auto space-y-8 animate-pulse">
            ...
            {/* Search Bar Skeleton */}
            <div className="h-14 w-full bg-muted rounded-2xl border border-border"></div>

            {/* List Skeleton */}
            <div className="space-y-4">
                {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="flex flex-col md:flex-row items-center justify-between p-5 bg-card rounded-3xl border border-border gap-5">
