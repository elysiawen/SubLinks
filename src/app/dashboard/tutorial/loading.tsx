        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-card to-purple-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8 text-center animate-pulse">
                    <div className="mx-auto w-16 h-16 bg-muted rounded-2xl mb-4"></div>
                    ...
                    <div className="max-w-7xl mx-auto animate-pulse">
                        <div className="bg-card rounded-2xl shadow-lg border border-border p-2">
                            <div className="flex flex-wrap gap-2">
                                {[1, 2, 3, 4, 5, 6].map((i) => (
                                    <div key={i} className="h-10 flex-1 min-w-[140px] bg-muted rounded-xl"></div>
                                ))}
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-card rounded-2xl shadow-sm border border-border p-8 lg:p-12 animate-pulse">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                        ...
                        <div className="lg:col-span-3 space-y-6">
                            ...
                            <div className="bg-muted border-l-4 border-border-strong p-6 rounded-r-xl">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="h-32 bg-muted rounded-xl border border-border"></div>
                                <div className="h-32 bg-muted rounded-xl border border-border"></div>
                            </div>
                        </div>
                    </div>
