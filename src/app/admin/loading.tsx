    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="w-4 h-4 border-2 border-border-input border-t-blue-600 rounded-full animate-spin"></div>
            ...
            <div className="flex gap-4 mb-6">
                <div className="h-10 bg-gradient-to-r from-white via-gray-50 to-white bg-[length:200%_100%] animate-shimmer border border-border-strong rounded-lg w-64 shadow-sm"></div>
                <div className="h-10 bg-gradient-to-r from-white via-gray-50 to-white bg-[length:200%_100%] animate-shimmer border border-border-strong rounded-lg w-32 shadow-sm"></div>
            </div>

            {/* Table/Content Skeleton */}
            <div className="bg-card rounded-xl shadow-sm border border-border overflow-hidden">
                {/* Table Header */}
                <div className="border-b border-border bg-muted/50 p-4 grid grid-cols-4 gap-4">
                ...
                <div className="divide-y divide-border">
                    {[1, 2, 3, 4, 5, 6, 7].map((i) => (
                        <div key={i} className="p-4 grid grid-cols-4 gap-4 items-center hover:bg-muted/50 transition-colors">
                            ...
                            <div className="h-6 bg-gradient-to-r from-gray-100 via-gray-50 to-gray-100 bg-[length:200%_100%] animate-shimmer rounded-full w-16 border border-border" style={{ animationDelay: `${i * 0.1}s` }}></div>
                            <div className="h-8 bg-gradient-to-r from-gray-100 via-gray-50 to-gray-100 bg-[length:200%_100%] animate-shimmer rounded w-20 border border-border" style={{ animationDelay: `${i * 0.1}s` }}></div>
                        </div>
                    ))}
                </div>
            </div>
