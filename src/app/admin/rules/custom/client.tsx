            ...
            >
                {isEditing && (
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-semibold text-text-secondary mb-2">{t('name')}</label>
                            <input
                                type="text"
                                value={formName}
...

            {
                rules.length === 0 ? (
                    <div className="bg-card rounded-xl p-12 text-center border border-border-strong shadow-sm">
                        ...
                        <h3 className="text-lg font-semibold text-text-primary mb-2">{t('noRules')}</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {rules.map((rule) => (
                            <div key={rule.id} className="bg-card rounded-xl border border-border shadow-sm hover:shadow-md transition-all group flex flex-col overflow-hidden">
                                    ...
                                    <div className="flex-1 min-w-0 pr-3">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <div className="text-xs text-text-tertiary flex items-center gap-1.5">
                                                ...
                                                <span className="truncate max-w-[120px] font-medium text-text-secondary" title={rule.username || t('unknownUser')}>{rule.username || t('unknownUser')}</span>
                                            </div>
