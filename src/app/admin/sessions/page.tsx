        ...
        <div className="p-4 sm:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-border-strong pb-8">
                <div className="space-y-1">
                    ...
                    <h1 className="text-4xl font-black text-text-primary tracking-tight">{t('pageTitle')}</h1>
            ...
            <div className="flex flex-col items-center gap-4 pt-8 border-t border-border">
                <div className="flex items-center gap-2 text-[10px] text-text-quaternary font-medium">
                    <span>{t('auditActive')}</span>
                    <span className="w-1.5 h-1.5 bg-green-500 rounded-full animate-pulse"></span>
                </div>
                <p className="text-[10px] text-text-tertiary text-center max-w-xl leading-relaxed">
                    {t('adminTip')}
                </p>
            </div>
        </div>
